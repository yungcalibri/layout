 ...
 * @module cover-l
 * @description
 * A custom element for arranging one, two, or three block-level elements evenly over a certain amount of vertical space.
 * @property {string} centered=h1 A simple selector for an element or class, representing the centered (main) element in the cover
 * @property {string} space=var(--s1) A CSS `padding` value representing the minimum space around and between child elements
